	          	...
	          	<div class="col-lg-9 offset-lg-2">
	            	<div class="pricing-item featured">
	            		...
	            		<h4>3x3 UTCC Championship 2023</h4>
							<form data-toggle="validator" role="form" id="registerForm" name="registerForm" action="editdata_checkregister_team.php" Method="Post" enctype="multipart/form-data">
						...
						<?php 
							...
							while ($row1 < 4){
								...
								$j = $row1+1;
						?>
							<form data-toggle="validator" role="form" id="editForm" name="editForm" action="editdata_checkregister_student.php" Method="Post" enctype="multipart/form-data">
