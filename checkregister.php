	...
	<div class="jumbotron">
		<div class="container">
    		<div class="row" style="margin-top:150px; margin-bottom:100px">
	            ...
	            <!--login form-->
					<form data-toggle="validator" role="form" name="loginForm" action="editdata_checkregister.php" Method="Post">
						<span style="color:#003366; font-size:18px; font-weight:700">3X3 UTCC Championship 2023</span><br>
						<span style="color:#003366; font-size:20px; font-weight:700">ตรวจสอบข้อมูลผู้สมัคร</h4><br><br>
	            	<!--login form-->
	                <div class="form-group">
	                    <div class="input-group">
	                        <div class="input-group-addon"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></div>
	                        	<input type="text" name="username" id="username" class="form-control" autocomplete="off"  placeholder="e-mail" style="font-size:12pt" required>
	                    </div>
	                </div>
	                <div class="form-group ">
	                    <div class="input-group ">
	                        <div class="input-group-addon"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span></div>
	                        	<input type="password" name="password" id = "password" class="form-control" autocomplete="off" placeholder="เบอร์โทรศัพท์" style="font-size:12pt" required>
	                    </div>
	                </div><br>            
	                <span style="color:#800000; font-size:16px; font-weight:400">* ใช้ e-mail และ เบอร์โทรศัพท์ผู้ควบคุมทีมที่ได้ลงทะเบียนไว้สำหรับ Login.</span>
    	...
    	<!-- Modal content-->
			<div class="modal-content">
				<div class="modal-body  " >
					<p><strong>Username หรือ Password ของท่านไม่ถูกต้อง กรุณาติดต่อผู้ดูแลระบบ</strong> 
				</div>
