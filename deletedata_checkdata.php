    		...
    		<div class="row " style="margin-top:150px; margin-bottom:50px">
	          	<div class="col-lg-9 offset-lg-2">
	            	<div class="pricing-item featured">
						...
						<?php } ?>	
						<form data-toggle="validator" role="form" id="deleteForm" name="deleteForm" action="deletedata_confirm.php" Method="Post" enctype="multipart/form-data">												  							  								  
						<div class="form-group">
							<div class="col-lg-offset-2 col-lg-10">
								<button type="button" class="btn btn-info btn-sm" onclick="history.back()">&nbsp;&nbsp;ยกเลิก&nbsp;&nbsp;</button>
